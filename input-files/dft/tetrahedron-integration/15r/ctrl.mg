...
SITE    ATOM=Mg POS=0.0 0.0 0.0
	...
	ATOM=Mg POS=0.0 0.0 3*{q}/2
	ATOM=Mg POS=0.0 sqrt(3)/3 2*{q}
	ATOM=Mg POS=0.5 sqrt(3)/6 5*{q}/2
	ATOM=Mg POS=0.0 sqrt(3)/3 3*{q}
	ATOM=Mg POS=0.0 0.0 7*{q}/2
	ATOM=Mg POS=0.5 sqrt(3)/6 4*{q}
	ATOM=Mg POS=0.0 0.0 9*{q}/2
	ATOM=Mg POS=0.0 sqrt(3)/3 5*{q}
	ATOM=Mg POS=0.0 0.0 11*{q}/2
	ATOM=Mg POS=0.5 sqrt(3)/6 6*{q}
	ATOM=Mg POS=0.0 sqrt(3)/3 13*{q}/2
	ATOM=Mg POS=0.5 sqrt(3)/6 7*{q}
