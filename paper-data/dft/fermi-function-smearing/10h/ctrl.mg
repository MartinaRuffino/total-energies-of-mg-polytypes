...
SITE    ATOM=Mg POS=0.0 0.0 0.0
	...
	ATOM=Mg POS=0.5 sqrt(3)/6 2*{q}
	ATOM=Mg POS=0.0 sqrt(3)/3 5*{q}/2
	ATOM=Mg POS=0.5 sqrt(3)/6 3*{q}
	ATOM=Mg POS=0.0 0.0 7*{q}/2
	ATOM=Mg POS=0.0 sqrt(3)/3 4*{q}
	ATOM=Mg POS=0.5 sqrt(3)/6 9*{q}/2
