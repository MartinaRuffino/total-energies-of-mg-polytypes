...
C --- Setup ---
      ...
      call sanrg(.true.,mode0,0,2,'yysbmm:','1s digit mode')
      call sanrg(.true.,mode1,0,2,'yysbmm:','10s digit mode')
      if (mode1 == 0) then
...
C --- Setup ---
      mode0 = mod(mode,10)
      mode1 = mod(mode/10,10)
      call sanrg(.true.,mode0,0,2,'yymsbm:','1s digit mode')
      call sanrg(.true.,mode1,0,2,'yymsbm:','10s digit mode')
      if (mode1 == 0) then
