      subroutine zfftqp(plat,jr,pos,n1,n2,n3,qp,nq,jq)
C- Fourier transform of complex function at a specified list of q-points
      implicit none
      integer n1,n2,n3,nq
      double precision plat(3,3),pos(3),qp(3,nq)
      double complex jr(n1,n2,n3),jq(nq)
C Local variables
      integer iq,j1,j2,j3
