...
C ----------------------------------------------------------------
      implicit none
      integer lpack,nlisti,listi(nlisti),x1(1),x2(1),x3(1),x4(1),x5(1)
...
C ----------------------------------------------------------------
      ...
      if (cast == 2) then
        if (ix == 1) call idscop(x1,xx,n,ni,nx)
        if (ix == 2) call idscop(x2,xx,n,ni,nx)
        if (ix == 3) call idscop(x3,xx,n,ni,nx)
        if (ix == 4) call idscop(x4,xx,n,ni,nx)
        if (ix == 5) call idscop(x5,xx,n,ni,nx)
      else
        if (ix == 1) call dpscop(x1,xx,n,ni,nx,1d0)
        if (ix == 2) call dpscop(x2,xx,n,ni,nx,1d0)
        if (ix == 3) call dpscop(x3,xx,n,ni,nx,1d0)
        if (ix == 4) call dpscop(x4,xx,n,ni,nx,1d0)
        if (ix == 5) call dpscop(x5,xx,n,ni,nx,1d0)
      endif
      end
...
C ----------------------------------------------------------------
      ...
      if (cast == 2) then
        if (ix == 1) call discop(xx,x1,n,nx,ni,1)
        if (ix == 2) call discop(xx,x2,n,nx,ni,1)
        if (ix == 3) call discop(xx,x3,n,nx,ni,1)
        if (ix == 4) call discop(xx,x4,n,nx,ni,1)
        if (ix == 5) call discop(xx,x5,n,nx,ni,1)
      else
        if (ix == 1) call dpscop(xx,x1,n,nx,ni,1d0)
        if (ix == 2) call dpscop(xx,x2,n,nx,ni,1d0)
        if (ix == 3) call dpscop(xx,x3,n,nx,ni,1d0)
        if (ix == 4) call dpscop(xx,x4,n,nx,ni,1d0)
        if (ix == 5) call dpscop(xx,x5,n,nx,ni,1d0)
      endif
      end
