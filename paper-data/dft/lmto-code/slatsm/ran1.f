...
C          x3 = ran1()
C          x4 = ran1()
C          if (fnc(x1,x2,0.0,0.0) < 1.0) iy(1) = iy(1)+1
C          if (fnc(x1,x2,x3,0.0) < 1.0) iy(2) = iy(2)+1
C          if (fnc(x1,x2,x3,x4) < 1.0) iy(3) = iy(3)+1
C   12   continue
C        do  13  i = 1, 3
...
C   14 continue
C      write(*,'(1x,/,t4,a,3f12.6,/)') 'actual',pi,4.0*pi/3.0,0.5*(pi**2)
C      end
c#endif
