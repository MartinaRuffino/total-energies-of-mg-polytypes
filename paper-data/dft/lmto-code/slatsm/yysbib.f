...
Cr
Cb Bugs
Cb   yysbib has not been tested for the hermitian case,
...
C --- Setup ---
      ...
      do  2  i = 1, j
        ...
        elseif (cs(i:i) == '4') then
          cm = 'N4'
        elseif (cs(i:i) == '1') then
          lsx1 = .true.
        elseif (cs(i:i) == '2') then
          lsx2 = .true.
...
C --- Straight inversion if n2 lt nmin ---
     ...
     .    offs,ar,ai,lda)
      ...
      if (lda < n2) call rx('yysbib: lda lt n')
...
C   --- x1 = c11 (b1 - a12 a22^-1 b2) ---
        ...
        if (ierr /= 0 .or. nb == 0 .or. lsx1) return
