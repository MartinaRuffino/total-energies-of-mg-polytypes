...
IO      SHOW=f HELP=F VERBOS=31,30,31 WKP=F IACTIV=0
TESTLMF lmfa --no-iactiv cu -vnk=8 -vbigbas=f
        lmf  --no-iactiv cu -vnk=8 -vbigbas=f -vpwmode=11 
        rm mixm.cu
        lmf  --no-iactiv cu -vnk=8 -vbigbas=t -vpwmode=11 
TSTMPIK lmfa --no-iactiv cu -vnk=8 -vbigbas=f
        mpirun -n 4 lmf --no-iactiv cu -vnk=8 -vbigbas=f -vpwmode=11 
        rm mixm.cu
        mpirun -n 4 lmf --no-iactiv cu -vnk=8 -vbigbas=t -vpwmode=11 
TEST3P  lmfa --no-iactiv cu -vnk=8 -vbigbas=t -vcupval=1 -vpwmode=11 
        lmf  --no-iactiv cu -vnk=8 -vbigbas=t -vcupval=1 --rs=0 -vpwmode=11 
TESTGW  lmfgwd --jobgw=-1 cu -vnk=8 -vbigbas=t -vpwmode=11 --make-Q0P --ib=1:10,12
        lmfgwd --jobgw=0 cu -vnk=8 -vbigbas=t -vpwmode=11 
        lmfgwd --jobgw=1 cu -vnk=8 -vbigbas=t -vpwmode=11 --wrange # --shorbz=no
        lmf2gw_0 cu
TESTGW2 lmfgwd --jobgw=-1 cu -vnk=8 -vbigbas=t -vpwmode=11 --make-Q0P --ib=1:10,12
        lmfgwd --jobgw=0 cu -vnk=8 -vbigbas=t -vpwmode=11 --gwcode=2
        lmfgwd --jobgw=1 cu -vnk=8 -vbigbas=t -vpwmode=11 --wrange --gwcode=2 # --shorbz=no
        lmf2gw_2 cu
TSTMPID lmfgwd --jobgw=-1 cu -vnk=8 -vbigbas=t -vpwmode=11 --make-Q0P --ib=1:10,12
        lmfgwd --jobgw=0 cu -vnk=8 -vbigbas=t -vpwmode=11 --gwcode=2
        mpirun -n 4 lmfgwd --jobgw=1 cu -vnk=8 -vbigbas=t -vpwmode=11 --wrange --gwcode=2 # --shorbz=no
        lmf2gw_2 cu
...
HAM     FORCES=0 XCFUN=2 ELIND=-.5 TOL=1e-6
        AUTOBAS[PNU=0 LOC=0 MTO=0 PFLOAT=0,0 xQLOC=.004]
        PWMODE={pwmode} PWEMIN={pwemin} PWEMAX={pwemax} OVEPS={oveps}
        GMAX=gmax
        FTMESH=10 10 10
#       v7: moved from OPTIONS
        NSPIN=1 REL=t
% const gwcode=0
GW      NKABC=nkgw GCUTB=2.7 GCUTX=2.2 CODE={gwcode}
% const hf=f
OPTIONS NSPIN=1 REL=t XCFUN=2 HF={hf} PFLOAT=0
