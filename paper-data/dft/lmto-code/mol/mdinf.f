      subroutine mdinf(nbas,amass,tstep,f,iclas,temp,relax,
...
C 100  format(f9.2,f10.2,6e12.3)
C 200  format(f9.2,4f14.8,3f12.8)
C 300  format(f9.2,9f11.6)
      end
