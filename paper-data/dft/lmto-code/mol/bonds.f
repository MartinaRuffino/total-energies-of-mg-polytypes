      subroutine bonds(dist0,nbas,bas,alat,atid)
C- Print table of bond angles and interatomic distances
C- Adapted from pr_bndang.f in nfp
      implicit none
      integer nnmax
      parameter (nnmax=100)
      integer nbas
      double precision bas(3,nbas),alat
      character*4 atid(1)

      integer nn,nd,na,numa,ipr,iprint,
     ...
     .            spp(50),sppn(50)
      character*40 s1,s2
      double precision pos(3,nnmax),dd(3),dda,aj,ai,dist(200),distr,
