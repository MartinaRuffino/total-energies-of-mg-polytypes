...
IO      SHOW=F HELP=F VERBOS=30 40 30 60 WKP=F
TESTLMF lmfa --no-iactiv c -vzbak=0
        lmf  --no-iactiv c -vzbak=0
TMPKLMF lmfa --no-iactiv c -vzbak=0
        mpirun -n 4 lmf  --no-iactiv c -vzbak=0
TMPLION lmfa --no-iactiv c -vzbak=1
        mpirun -n 4 lmf  --no-iactiv c -vzbak=1
...
OPTIONS NSPIN=2 REL=t FRZ=0 NRMIX=2 TPAN=0 HF=hf ESP=F XCN=0 LMH=0 RQUAD=2
        XCFUN=2 FORCES=12
        PFLOAT=0
% ifdef minx
