      subroutine hklgbl(p,rsm,e,q,kmax,nlm,k0,nlm0,cy,s_lat,
     .  hkl,ghkl)
C- Bloch-sums of k,L-dependent smooth hankel functions and gradients at a point
C ----------------------------------------------------------------------
Cio Structures
...
C ... Passed parameters
      ...
      double precision q(3),p(3),cy(*),e,rsm
...
C ... Make Hkl's up to one higher in l and k
      call hklbl(p,rsm,e,q,kmax+1,nlm1,k0,cy,s_lat,hkl)
