      subroutine prodbaschka(mode,s_lat,s_site,s_spec,ig,nl,nsp,nbas,nat,ndrphi,
     .  nrphiv,nrphic,ndrpb,nrpb,ntpba,ndlmto,rprbme,prbasme)
...
C ... Passed parameters
      integer mode,nl,nsp,nbas,nat,ndrphi,ig,ndrpb,ndlmto
...
C ... Local parameters
      ...
      integer indxpb(3,ndrpb*nl*nl),pbindx(ndrpb,nl*nl),nblr(0:2*(nl-1))
...
C       Debugging
        call mtoindex(2*nl-2,nblr,-1,ndrpb,indxpb,pbindx,npbi)
        ...
        call prodbaschki(nl,ndrphi,nmtoi,ndlmto,ntpbi,nblr,indxlm,cgr,rprbme(0,1,0,1,0,1+offpr),
     .    prbasme(1,1,1+offpb))
        offpr = offpr + mxrbli
        offpb = offpb + ntpba(0)
      ...
      subroutine prodbaschki(nl,ndrphi,nmtoi,ndlmto,ntpbi,nblr,indxlm,cgr,rprbme,prbasme)
