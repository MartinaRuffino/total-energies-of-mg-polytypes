...
C --- Read branch ---
  100 continue
      ...
      call rxx(ndim1 /= ndim,'BZMIO: ndim1 ne ndim')
      call rxx(npln1 /= npln,'BZMIO: npln1 ne npln')
      call rxx(nwmx1 /= nwmx,'BZMIO: nwmx1 ne nwmx')
      call rxx(nqmx1 /= nqmx,'BZMIO: nqmx1 ne nqmx')
