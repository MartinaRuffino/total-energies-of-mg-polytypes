...
C      subroutine fmain
C      implicit none
C      double precision ef,e1,e2,e,d,s,xx,x,w,om
C
C      e1=-.5d0
C      e2=.5d0
C      e = e2-e1
...
C        x = (om - e) / w
C
C        call delstp(1,x,d,s,xx)
C
CC        call delstp(1,x-ef,d1,s,xx)
CC        call delstp(1,x-e1,d1,s,xx)
C
C        print *, om, x, d
C
C      enddo
