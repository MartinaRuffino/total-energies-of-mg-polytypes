...
Ci   lsort   : if .true. then rsq must be ordered as rsq(i-1) <= rsq(i)
Co Outputs
Co   n1,n2   : indices corresponding to boundaries of the bins
Co   idx     : permutation indices; not used if lsort = .true.
Co   wk      : an array containing permuted rsq; not used if
Co           : lsort = .true.
