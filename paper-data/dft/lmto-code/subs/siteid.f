...
C ... Passed parameters
      ...
      double precision bas(3,*),pos(3,*),plat(3,3)
      parameter (niax=10)
      integer iax(niax,*)
C Local variables
...
C ----------------------------------------------------------------------
      implicit none
C     Passed parameters
      integer mode,ia,ib,ntab(1),niax,lsta(*),lstb(*),nlst
      parameter (niax=10)
      integer iax(niax,*)
C     Local variables
