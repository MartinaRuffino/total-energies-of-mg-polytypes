...
C ... Passed parameters
      ...
      parameter (niax=10)
      integer iax(niax,1),iaxib(niax,nbas,*)
C ... Local parameters
...
C   ... Copy from iaxib to iax
          ...
          do  is = is0+1, is0+ntabib(ib)
            if (iaxib(1,ib,is-is0) == 0 .or.
     .          iaxib(2,ib,is-is0) == 0) then
              shrink = shrink+1
            else
